...
import {
  instantBankAccountOpeningConstant,
  instantBankAccountOpeningBenefits,
  instantBankAccountOpeningFeatures,
...
export const Banking = () => {
  return (
    <>
      <Hero {...instantBankAccountOpeningConstant} className="lg:mt-10" />
      <section className="cardTheme">
        <div className="w-11/12 md:w-[65%] mx-auto py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-10 place-items-center mb-20">
            {instantBankAccountOpeningFeatures.map(feature => (
              <div
                key={feature.heading}
          ...
          <Link
            to={'/login'}
            className="flex justify-center items-center mx-auto bg-primary rounded-xl py-5 px-4 text-center text-white text-xl w-[50%]"
          >
