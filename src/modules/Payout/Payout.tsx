...
export const Payout = () => {
  return (
    <>
      <Hero {...PayoutConstant} className="lg:mt-10" />
      <section className="cardTheme">
        <div className="w-11/12 md:w-[65%] mx-auto py-20">
          ...
          <Link
            to={'/pricing'}
            className="flex justify-center mx-auto items-center bg-primary rounded-xl py-5 px-4 text-center text-white text-xl w-[50%]"
          >
      ...
      <section className="cardTheme">
        <div className="w-11/12 md:w-[65%] mx-auto py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-10 place-items-center">
            {payoutBenefits.map((benefit, idx) => (
              <div
                key={benefit.desc}
